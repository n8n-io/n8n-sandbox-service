...
type RunnerHeartbeat struct {
	...
	// Managed sandboxes that are stopped and not occupying a concurrent-VM slot.
	CapacityStopped int32 `protobuf:"varint,7,opt,name=capacity_stopped,json=capacityStopped,proto3" json:"capacity_stopped,omitempty"`
...
func (x *RunnerHeartbeat) GetCapacityStopped() int32 {
	if x != nil {
		return x.CapacityStopped
	}
	return 0
}
...
const file_proto_runner_v1_runner_proto_rawDesc = "" +
	"\n" +
	"\x1cproto/runner/v1/runner.proto\x12\trunner.v1\"\x8f\x02\n" +
